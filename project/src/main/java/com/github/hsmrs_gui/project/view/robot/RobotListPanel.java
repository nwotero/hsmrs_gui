...
public class RobotListPanel extends JPanel{
	...
	public RobotListPanel(ListModel listModel) {
		...
		btnAddTask = new JButton("New robot");
		
		this.setBackground(Color.white);
		this.setBorder(BorderFactory.createMatteBorder(1, 3, 3, 1, Color.black));
		this.setLayout(new MigLayout("insets 0", "[left, fill]", "[]0[]0[fill]"));
		this.add(lblTitle, "wrap");
		this.add(btnAddTask, "gapleft 0%, gapright 50%, wrap");
		this.add(robotListView, "pushx, growx, wrap");
